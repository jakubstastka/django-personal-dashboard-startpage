...
from .views import BoardList, BoardCreateView, BoardDeleteView, BoardUpdateView, BookmarkGroupCreateView, BookmarkCreateView, BookmarkGroupDeleteView, BookmarkDeleteView
